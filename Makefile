...
all: $(FINAL_C166_PATCH) $(FINAL_L166_PATCH) $(RUNTIME_LIBS) $(FINAL_INSTALLER)
...
$(C166_ORIGINAL) $(L166_ORIGINAL): $(RUNTIME_EXTRACTED)
	@test -f $@
...
$(FINAL_INSTALLER): $(ORIGINAL_INSTALLER) $(C166_PATCHED) $(L166_PATCHED) \
...
clean:
	...
	rm -rf -- $(RUNTIME_WORK)
	rm -rf -- lib
	rm -f -- $(FINAL_C166_PATCH) $(FINAL_L166_PATCH) $(FINAL_INSTALLER)
